## Future Plans
- Move TUI into GUI for first time setup - allowing immediate access to easy GUI setup
...
- File operational bugs in issue tracker as they are discovered (workspace version 0.8.52).