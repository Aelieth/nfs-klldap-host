...
/// One line of fs-warnings output for a share (capable shares omitted...
...
impl FsShareWarning {
    /// Stable single-line report for CLI / healthcheck (limited shares inc...
...
/// UI badge text using an explicit mountinfo fixture file (isolates te...
