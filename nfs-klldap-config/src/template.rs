...
# The container auto-derives sssd.conf, krb5.conf,
# and all Ganesha EXPORT fragments.
#
...
[management]
# webui_admin_group = "lldap_admin" # Default - Edit to change group for WebUI
# admins

[server]
# hostname = "myhost.example.com" # Default - Optional override for keytab
# only.
# Recommended: docker run --uts=host
...
# ldap_user_search_base = "ou=people,dc=example,dc=com" # Optional - defaults
# to dc=<realm> (Subtree)
# ldap_group_search_base = "ou=people,dc=example,dc=com" # Optional - defaults
# to dc=<realm> (Subtree)
...
# ldap_id_use_start_tls = true # only with ldap:// + STARTTLS

[kerberos]
# realm = "EXAMPLE.COM" # Default - auto-derived from ldap_uri host, edit to
# override
