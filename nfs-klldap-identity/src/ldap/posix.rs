// !POSIX LDAP attribute mapping and search-base derivation (no TOML/serd...
...
/// Plain inputs for resolving POSIX attribute names (mirrors [sssd] TO...
...
/// Resolves POSIX attribute names from optional overrides (or built-in...
...
/// Effective user/group search bases (Subtree) from overrides or realm...
