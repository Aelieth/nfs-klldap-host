...
run grep-deprecated-ganesha-keys grep -nE 'Manage_Gids_Expiration|IdmapConf|Read_Access_Check_Policy' nfs-klldap-config/src/generate.rs | grep -v 'comment\|omitted\|NOACL\|default pre' || true
